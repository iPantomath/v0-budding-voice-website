...
export function Hero() {
  return (
    <section className="relative bg-muted overflow-hidden pt-24 pb-16 lg:pt-32 lg:pb-24">
      {/* Background accent */}
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 lg:grid-cols-2 lg:gap-16 lg:px-8">
        ...
        <div className="flex flex-col items-start gap-6">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-whatsapp px-7 py-3.5 text-base font-semibold text-white shadow-lg shadow-secondary/25 transition-all hover:brightness-110"
          >
